...
def main():
    ...
    original_title = '<p style="font-family:Courier; color:Blue; font-size: 20px;">Mnase Digestion QC Prediction App🧬</p>'
    st.title(original_title, unsafe_allow_html=True)
